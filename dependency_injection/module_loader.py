...
class ModuleLoader:
    ...
    def _load_from_package(self, package_path: str, stats: Dict[str, int]) -> None:
            ...
            for _, subpackage_name, is_pkg in pkgutil.iter_modules(
                ...
                if is_pkg:
                    ...
                    try:
                        ...
                        logger.warning(f"Failed to import module {subpackage_name}: {e}")
            ...
            if hasattr(obj, "__injectable__"):
                ...
                if interface != obj:
                    ...
                    try:
                        ...
                        stats["interfaces"] += 1
                        logger.debug(f"Registered self-implementing service: {obj.__name__}")
                    except Exception as e:
