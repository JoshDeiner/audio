"""File-based transcription service implementation for audio transcription tool."""
...
@Injectable(interface=IFileTranscriptionService)
class FileTranscriptionService(IFileTranscriptionService):
