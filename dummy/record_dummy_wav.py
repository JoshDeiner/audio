...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Record or generate dummy WAV file')
    parser.add_argument('--output', '-o', type=str, default='dummy_speech.wav',
...
if __name__ == "__main__":
    args = parse_args()
    record_wav(filename=args.output, duration=args.duration, samplerate=args.sample_rate)
