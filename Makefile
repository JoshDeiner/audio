.PHONY: help setup update update-all docker-run local-run docker-build docker-stop clean test-dummy test-dummy-speech test-dummy-en test-file test-dir test-file-en test-dir-en test-file-model test-dir-model test-suite test-languages test-seed-sine test-seed-speech test-seed-multi test-seed-suite transcribe transcribe-en transcribe-model test test-unit test-integration audio-in audio-out conversation state-machine-user
...
help:
	...
	@echo "  make state-machine-user CYCLES=3 DURATION=5 MODEL=tiny - Run with custom options"
	@echo ""
