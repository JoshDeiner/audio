...
class FileOutputPlugin(OutputPlugin):
    ...
    def initialize(self, config_manager: Optional[ConfigurationManager] = None) -> None:
        ...
        self._output_dir = self.config_manager.get("AUDIO_OUTPUT_DIR", "output")
        ...
        if not os.path.exists(self._output_dir):
            try:
                ...
                raise FileOperationError(f"Failed to create output directory: {e}")
        ...
        logger.info(f"Initialized file output plugin (dir: {self._output_dir})")
    ...
    def handle_transcription(self, transcription: str, 
        ...
        try:
            ...
            if metadata and "source_file" in metadata:
                ...
                filename = f"{self._file_prefix}{timestamp}{self._file_extension}"
