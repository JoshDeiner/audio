...
class TestTranscription:
    ...
    def test_file_transcription(self):
        ...
        assert len(transcription) > 5, "Transcription should have more than 5 characters"
        ...
        assert file_content == transcription, "File content should match transcription result"