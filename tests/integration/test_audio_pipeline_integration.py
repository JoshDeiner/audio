...
def test_audio_in_pipeline_prints_transcription(tmp_path: Path, temp_config_manager, platform_service, file_service, audio_service) -> None:
...
@pytest.mark.integration
def test_audio_out_pipeline_uses_default_text(tmp_path: Path, temp_config_manager, platform_service, file_service, audio_service) -> None:
...
def test_audio_out_pipeline_uses_custom_text_and_output(
    tmp_path: Path, temp_config_manager, platform_service, file_service, audio_service
) -> None:
...
@pytest.mark.integration
def test_audio_out_pipeline_with_play_flag(tmp_path: Path, temp_config_manager, platform_service, file_service, audio_service) -> None:
