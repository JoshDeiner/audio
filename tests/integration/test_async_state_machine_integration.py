...
class TestAsyncStateMachineIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_two_cycle_run(self, setup_environment, test_config, mock_audio_file):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_state_transition_sequence(self, setup_environment, test_config, mock_audio_file):
        ...
        # Configure mock behavior
        mock_audio_service.record_audio.return_value = mock_audio_file
        mock_transcription_service.transcribe_audio.return_value = "Test message"
    ...
    async def test_async_timing_behavior(self, setup_environment, test_config):
        ...
        mock_transcription_service.transcribe_audio.return_value = "Test transcription"
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_failure_on_second_audio_in(self, setup_environment, test_config, mock_audio_file):
        ...
        mock_transcription_service.transcribe_audio.return_value = "First message"
