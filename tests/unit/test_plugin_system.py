...
class TestPluginManager:
    ...
    def setup_method(self) -> None:
        ...
        PluginRegistry.register_plugin_class("transcription", MockTranscriptionPlugin)
        PluginRegistry.register_plugin_class("audio_format", MockAudioFormatPlugin)
        PluginRegistry.register_plugin_class("output", MockOutputPlugin)
        PluginRegistry.register_plugin_class("preprocessing", MockPreprocessingPlugin)
    ...
    def test_get_transcription_plugin(self) -> None:
        ...
        plugin = self.plugin_manager.get_transcription_plugin("mock_transcription")
    ...
    def test_get_audio_format_plugin(self) -> None:
        ...
        plugin = self.plugin_manager.get_audio_format_plugin("mock_audio_format")
    ...
    def test_get_preprocessing_plugin(self) -> None:
        ...
        plugin = self.plugin_manager.get_preprocessing_plugin("mock_preprocessing")
        ...
        sample_rate = 16000
        processed_data, processed_rate = plugin.process_audio(audio_data, sample_rate)
    ...
    def test_get_available_plugins(self) -> None:
        ...
        # Get specific type
        transcription_plugins = self.plugin_manager.get_available_plugins("transcription")
