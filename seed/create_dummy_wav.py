...
def main():
    ...
    parser.add_argument("--output", "-o", default="input/dummy_sine.wav", help="Output file path")
    parser.add_argument("--duration", "-d", type=float, default=5.0, help="Duration in seconds")
    parser.add_argument("--frequency", "-f", type=float, default=440.0, help="Frequency in Hz")
    parser.add_argument("--sample-rate", "-sr", type=int, default=16000, help="Sample rate in Hz")
