...
def main():
    ...
    if args.language:
        ...
        if args.language not in LANGUAGE_SAMPLES and not args.text:
            print(f"Error: Language '{args.language}' not supported and no custom text provided.")
